...
/**
 * RAG retrieval service that searches the vector store for similar math questions.
 * Supports grade-level filtering: only returns questions at or below the queried grade.
 */
@Service
public class RagRetrievalService {
    ...
    /**
     * Retrieves the top-K most similar questions from the vector store,
     * filtered to only include questions at or below the given grade level.
     *
     * @param question the input question text
